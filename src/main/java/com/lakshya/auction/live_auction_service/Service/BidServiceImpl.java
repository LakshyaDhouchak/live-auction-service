...
public class BidServiceImpl implements BidService {
    ...
    public BidResponseDTO createBid(BidPlacementDTO dto) {
        ...
        // --- Check highest bid ---
        BigDecimal highestBid = repo.findHighestAmountByActionItem(dto.getAuctionItemId())
        ...
        log.info("New bid placed: AuctionItem={}, User={}, Amount={}", auctionItem.getId(), user.getId(), dto.getAmount());
